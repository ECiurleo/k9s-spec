...
%changelog
* Tue Jun 18 2024 Emanuele Ciurleo <emanuele@ciurleo.com> - %{version}
- Build of version %{version} - changes here https://github.com/derailed/k9s/releases/tag/v%{version}
* Wed Mar 06 2024 Emanuele Ciurleo <emanuele@ciurleo.com> - 0.32.4
- Build of version 0.32.3 - changes here https://github.com/derailed/k9s/releases/tag/v0.32.4
